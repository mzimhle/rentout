<?php /* Smarty version 2.6.20, created on 2015-02-05 20:22:40
         compiled from /home/rentoutco/public_html/templates/booking/invoice/cancellation.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', '/home/rentoutco/public_html/templates/booking/invoice/cancellation.html', 38, false),array('function', 'date_diff', '/home/rentoutco/public_html/templates/booking/invoice/cancellation.html', 39, false),)), $this); ?>
<html>
<head>
                    	...
                    	<table width="600" border="0" align="left" cellpadding="16" cellspacing="0" bgcolor="#FFFFFF">
                        	<tr>
                            	<td valign="top" style="font-size: 12px; font-family: Helvetica, Verdana, Arial, sans-serif; color: #4c4c4c;" bgcolor="#FFFFFF">
                                	<span style="font-family: 'Source Sans Pro', Helvetica, Verdana, Arial, sans-serif; font-size: 20px; font-weight: bold; color: #156080; text-transform: uppercase;">Booking Cancellation</span><br />
									<p>Good day,</p>
									<p><b><?php echo $this->_tpl_vars['mailinglist']['participant_name']; ?>
 <?php echo $this->_tpl_vars['mailinglist']['participant_surname']; ?>
's</b> booking has been <b style="color: red;">cancelled</b> by <b><?php echo $this->_tpl_vars['mailinglist']['car_owner']; ?>
...
,  <?php echo $this->_tpl_vars['mailinglist']['model_name']; ?>
									...
									<p>Booking was for <b><?php echo smarty_function_date_diff(array('date1' => $this->_tpl_vars['mailinglist']['booking_startdate'],'date2' => $this->_tpl_vars['mailinglist']['booking_enddate']), $this);?>
...
</b>. <?php if ($this->_tpl_vars['mailinglist']['booking_message'] != ''): ?>Below is a message from RentOut:</p>
