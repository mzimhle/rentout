<?php /* Smarty version 2.6.20, created on 2015-02-23 09:30:56
         compiled from templates/register/activate.html */ ?>
<html>
<head>
                    	...
                    	<table width="600" border="0" align="left" cellpadding="16" cellspacing="0" bgcolor="#FFFFFF">
                        	<tr>
                            	<td valign="top" style="font-size: 12px; font-family: Helvetica, Verdana, Arial, sans-serif; color: #4c4c4c;" bgcolor="#FFFFFF">
                                	<span style="font-family: 'Source Sans Pro', Helvetica, Verdana, Arial, sans-serif; font-size: 20px; font-weight: bold; color: #156080; text-transform: uppercase;">Activate Registration</span><br /><br />
									Good day <?php echo $this->_tpl_vars['mailinglist']['mailinglist_name']; ?>
 <?php echo $this->_tpl_vars['mailinglist']['mailinglist_surname']; ?>
,
									<br /><br />
									Your account has been activated, please see below login details<br /><br />									
									<table style="font-size: 12px; font-family: Helvetica, Verdana, Arial, sans-serif; color: #4c4c4c;">
										<tr>
											<td><b>Username</b></td><td>:</td><td><?php echo $this->_tpl_vars['mailinglist']['participantlogin_username']; ?>
</td>
										</tr>
										<tr>
											<td><b>Password</b></td><td>:</td><td><?php echo $this->_tpl_vars['mailinglist']['participantlogin_password']; ?>
</td>
										</tr>
									</table>									
									<br />
									Please go to our website <a href="http://www.rentout.co.za/">www.rentout.co.za</a>.
