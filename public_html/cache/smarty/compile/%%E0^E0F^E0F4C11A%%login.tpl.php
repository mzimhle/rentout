<?php /* Smarty version 2.6.20, created on 2015-02-11 21:22:08
...
" title="Details">Details</a></li>
		  ...
		  <form name="loginForm" id="loginForm" action="/participant/view/login.php?code=<?php echo $this->_tpl_vars['participantData']['participant_code']; ?>
" method="post">
...
<?php echo '",
				...
				success: function(data){
						if(data.result == 1) {
							...
							window.location.href = \'/participant/view/login.php?code='; ?>
<?php echo $this->_tpl_vars['participantData']['participant_code']; ?>
<?php echo '\';
						} else {
							alert(data.message);
