                                ...
                                <div role="tabpanel" class="tab-pane active" id="reg">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <p>Good day {$participantData.participant_name} {$participantData.participant_surname}, thank you for registering, we have sent you an email to activate your email address to confirm that your email is valid. <a href="/">Please click here to go to the home page</a>.</p>
                                            <hr />
