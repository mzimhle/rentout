<?php /* Smarty version 2.6.20, created on 2015-01-04 23:02:04
...
smarty_core_smarty_include_php(array('smarty_file' => 'includes/header.php', 'smarty_assign' => '', 'smarty_once' => false, 'smarty_include_vars' => array()), $this); ?>
	...
	<div id="breadcrumb">
        <ul>
			...
			<li><a href="/participant/view/" title="Participants">Participants</a></li>
...
" size="30" />
			...
			<td>
				...
				<select name="participant_type" id="participant_type">
					...
					<option value="LESSOR"> Car Lessor</option>
				</select>
				<br /><?php if (isset ( $this->_tpl_vars['errorArray']['participant_type'] )): ?><span class="error"><?php echo $this->_tpl_vars['errorArray']['participant_type']; ?>
</span><?php else: ?><em>Participant owns cars or someone who is renting a car</em><?php endif; ?>
			</td>							
          </tr>
			<tr>
				<td>
...
" size="30" />
          ...
          <tr>            
			...
			<td colspan="2">
				<h4 <?php if (isset ( $this->_tpl_vars['errorArray']['profilelogo'] )): ?>class="error"<?php endif; ?>>Upload Image:</h4><br />
				<?php if (isset ( $this->_tpl_vars['companyData']['participant_image_name'] ) && trim ( $this->_tpl_vars['companyData']['participant_image_name'] ) != ''): ?>
					<br /><img src="<?php echo $this->_tpl_vars['companyData']['participant_image_path']; ?>
tny_<?php echo $this->_tpl_vars['companyData']['participant_image_name']; ?>
<?php echo $this->_tpl_vars['companyData']['participant_image_ext']; ?>
" />
				<?php else: ?>
