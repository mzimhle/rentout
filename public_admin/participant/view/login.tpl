  ...
  <div id="content">
	...
	<div id="breadcrumb">
        <ul>
			...
			<li><a href="/participant/view/details.php?code={$participantData.participant_code}" title="Jobs">{$participantData.participant_name} {$participantData.participant_surname}</a></li>
			<li>Logins</li>
        </ul>
	</div><!--breadcrumb-->
	<div class="inner">
    ...
    <div id="sidetabs">
        <ul > 
            <li><a href="/participant/view/details.php?code={$participantData.participant_code}" title="Details">Details</a></li>
			<li class="active"><a href="#" title="Login">Login</a></li>			
        </ul>
    </div><!--tabs-->		  
		  <div class="detail_box">  
		  <form name="loginForm" id="loginForm" action="/participant/view/login.php?code={$participantData.participant_code}" method="post">
		...
		$.ajax({
				...
				success: function(data){
						if(data.result == 1) {
							...
							window.location.href = '/participant/view/login.php?code={/literal}{$participantData.participant_code}{literal}';
						} else {
							alert(data.message);
						}
				}
